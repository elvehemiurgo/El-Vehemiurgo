---
match: "Kyle Fletcher & Kevin Knight vs The Young Bucks — Tables Match"
slug: "2026-09-09-fletcher-knight-vs-young-bucks-tables-aew-rebel-heart"
participantes: ["Kyle Fletcher", "Kevin Knight", "Matt Jackson", "Nick Jackson"]
empresa: "AEW"
...
estipulacion: "Tables Match"
duracion: "15:22"
finish: "Kevin Knight atraviesa una mesa primero (superkick de Nick + empujón de Matt); Kyle Fletcher responde mandando a Nick Jackson por otra mesa del lado opuesto"
...
# Kyle Fletcher & Kevin Knight vs Young Bucks — Tables Match (Rebel Heart, 9/9/2026)

> **Instant Classic Crown** (PW·FS·WE). *"Buena chance de redención
> para los Young Bucks"* — pero la reserva de siempre persiste: falta
> mic y comebacks, no ejecución.

## Resumen

Timestamp **01:44:58**. **15:22.** Kyle Fletcher y Kevin Knight
vencen a los Young Bucks en un Tables Match. Finish: Knight atraviesa
una mesa primero (superkick de Nick + empujón de Matt); Fletcher
responde mandando a Nick por otra mesa del lado opuesto. **Post-match**:
FTR y Stokely Hathaway ayudan a Fletcher/Knight, sumándose al ataque
de la Don Callis Family sobre los Bucks; **Darby Allin y Steven Borden
corren con sillas** a hacer el save.

## Lectura del Vehemiurgo

- **Por qué está en mi base**: triple clase declarada, sin corona +.
- **Veces que lo vi**: 1.
...
> *"Fletcher & Knight vs Young Bucks, me esperaba una buena lucha
> estilo Fletcher, buena chance de redención para los young bucks,
> aunqeu si ponen buenas luchas, lo que les está faltando es mic y
> buenos comebacks; se merecen las 3 clases"*
>
> — El Vehemiurgo, 2026-09-18 s01 (verbatim, typos preservados)

**Lectura sintética**:

1. **"Chance de redención"**: encuadre distinto al de la rivalidad
   con Cage & Cope (guion 009) — acá el Vehemiurgo ve una oportunidad
   real, no una decepción consumada.
2. **La reserva se mantiene idéntica a la de todo el verano**: *"lo
   que les está faltando es mic y buenos comebacks"* — el problema
   nunca fue in-ring, siempre fue de promo/reacción.
3. **El save de Darby y Borden** conecta este match con el proyecto de
   long-term booking que el archivo sigue desde agosto — Borden
