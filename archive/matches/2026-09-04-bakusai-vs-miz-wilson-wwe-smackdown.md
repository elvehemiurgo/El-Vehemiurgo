---
match: "Bakusai (Shinsuke Nakamura & Kyoki) vs The Miz & Kit Wilson"
slug: "2026-09-04-bakusai-vs-miz-wilson-wwe-smackdown"
participantes: ["Shinsuke Nakamura", "Kyoki", "The Miz", "Kit Wilson"]
empresa: "WWE"
programa: "SmackDown"
fecha: 2026-09-04
...
> **Instant Classic Crown.** *"Tener al time ticking bomb contra The
> Miz es una dream match"* — y la mantienen muy real.

> **Ubicación en el visionado del Vehemiurgo (VLC)**: 00:47:25

## Lectura del Vehemiurgo

**Cita verbatim**:

> *"el debut de bakusai estuvo cool [...] además tener al time tiking
> bomb contra The Miz es una dream match, y mantienen la lucha muy
> real, se merecen las 3 clases"*
>
> — El Vehemiurgo, 2026-09-11 s67 (verbatim, typos preservados)

**Lectura sintética**: el elogio de match separa lo puramente
in-ring (*"la mantienen muy real"*, dream match generacional contra
The Miz) de la lectura de presentación/gimmick, registrada aparte en
[`../segments/2026-09-04-debut-bakusai-presentacion-wwe-smackdown.md`](../segments/2026-09-04-debut-bakusai-presentacion-wwe-smackdown.md).

## Datos confirmados por research — corrección central de identidad

- **"Bakusai" NO es el gimmick individual de Hiromu Takahashi.** El
  nombre de ring individual de Hiromu es **Kyoki**, revelado el
  21/8/2026 como nuevo compañero de **Shinsuke Nakamura**. **Bakusai
  es el nombre del EQUIPO** (Nakamura & Kyoki), revelado el 28/8/2026.
  Ver [`../../glossary/nombres-canonicos.md`](../../glossary/nombres-canonicos.md).
- **Fue un match de PAREJAS, no singles vs The Miz**: **Bakusai
  (Nakamura & Kyoki) vs The Miz & Kit Wilson (Pretty Deadly)**,
  debutado directamente en el roster principal de SmackDown (no en
  NXT). Kyoki ya había debutado en un dark match el 24/8 (Ottawa).
- **Ganan Bakusai**: Wilson intenta un Stunner invertido sobre Kyoki;
  este lo revierte y lo fija en una combinación de pin.
- **Post-match**: **MFT** (los actuales WWE Tag Team Champions,
  acompañados por Haku) salen a encarar a Bakusai desde el escenario
...
- [`../segments/2026-09-04-debut-bakusai-presentacion-wwe-smackdown.md`](../segments/2026-09-04-debut-bakusai-presentacion-wwe-smackdown.md)
- [`../promotions/bakusai.md`](../promotions/bakusai.md) · [`../promotions/mfts.md`](../promotions/mfts.md)
- [`../people/kyoki.md`](../people/kyoki.md) · [`../people/kit-wilson.md`](../people/kit-wilson.md)
