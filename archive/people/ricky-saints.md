...
> El Vehemiurgo escribe el nombre como **Ricky Saints**. Es
> probable que refiera al talent ex-AEW conocido como **Ricky
> Starks** (ex-NWA World Champion), rebrandeado para WWE NXT.
> Pendiente confirmar grafía oficial WWE.

## Identificación

- **Nombres de gimmick** (cronológico): Ricky Starks (NWA, AEW),
  **Ricky Saints** (WWE NXT, presumido rebrand).
- **Promoción actual (mayo 2026)**: WWE main roster (SmackDown
  call-up post-WM42 según
  [`topics/tko-contracts-2025-2026.md`](../topics/tko-contracts-2025-2026.md)).
- **Trayectoria larga**: indie circuit → NWA (NWA World Champion) →
  AEW 2020-2024 → WWE NXT 2025-2026 → main roster.

## Datos duros

- **Debut profesional**: 2013 ish, indie texano.
- **NWA World Heavyweight Champion**: 2020 (verificar fechas).
- **AEW**: 2020-2024 con FTW Championship runs y angle con Powerhouse
  Hobbs.
- **WWE NXT**: 2025-2026, pieza central del main event NXT — el
  "triángulo" con Ethan Page y Joe Hendry según lectura editorial
  del Vehemiurgo.
- **Main event NXT Stand & Deliver 2026 (04 abr)**: 4-way con
  Ethan Page, Joe Hendry y Tony D'Angelo (ver
...
- Múltiples en su run AEW (*Talk Is Jericho*, *Insight*).
  Pendiente catalogar.
...
**Lectura sintética sobre Ricky**:

- **Booking diferente al de Ethan y Joe**: el triángulo se
  sostiene porque cada vértice trabaja con identidad propia.
  Ricky trae el recorrido NWA + AEW (FTW Title, ex-NWA Champion) —
  pedigree top guy independiente que la oficina WWE finalmente
  reconoce.
- **Coincidencia en main event NXT como catalizador**.
- **Carga, rinde, vende un gran año de rivalidades** — los tres
  verbos del oficio cumplidos.
- **Proyección a SmackDown / Raw como Fatal Influence** —
  paralelo importante, talent que **mantiene peso editorial post
  call-up**.
- **"El presente del wrestling"** — veredicto compartido con Ethan
  y Joe.

**Línea editorial cruzada**: ver
[`ethan-page.md`](./ethan-page.md),
[`joe-hendry.md`](./joe-hendry.md), y la pieza al horno
*"El triángulo Ethan / Ricky / Joe: cómo NXT 2025-2026 fabricó
tres top guys distintos a la vez"*.
...
- [ ] **Confirmar grafía oficial WWE** — *Ricky Saints* o *Ricky
      Starks*. Posible rebrand del talent en su salto a WWE.
- [ ] Fechas exactas del NWA World Title run.
- [ ] Run AEW completo (FTW Title, angles).
...
> *"Ricky y Cardona cruzan caminos, buena promos de ambos, se
> merece un enterteinment class este segmento backstage."*
>
> — El Vehemiurgo, 2026-07-14 s42 (verbatim)

**Cita verbatim** (match):

> *"Ricky vs Cardona se merece un fighting spirit, estuvo cool, muy
> cuidado Ricky hasta ahora, lo estn armando muy bien, me gustó la
> lucha."*
>
> — El Vehemiurgo, 2026-07-14 s42 (verbatim)
