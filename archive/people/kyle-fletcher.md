...
> Primer registro del archivo. Parte del climax del segmento
> post-Okada/Takeshita en Double or Nothing (24/5/2026) — el
> booking que derivó en el turn babyface de Takeshita.

## Identificación

- **Nombre de gimmick**: Kyle Fletcher.
- **Nombre real**: [verif].
- **Equipo signature**: ***Aussie Open*** (con Mark Davis) —
  tag team australiano.
- **Empresa actual (2026)**: AEW — órbita Don Callis Family
  [verif].

## Trayectoria condensada

- **24/5/2026 (AEW Double or Nothing)** — parte del climax del
  segmento post-match Okada/Takeshita: booking *"perfecto"*,
  deriva en el turn babyface de Takeshita.
  ([→](../segments/2026-05-24-don-callis-fletcher-takeshita-post-match-aew-double-or-nothing.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s17 — Parte del climax perfecto

**Cita verbatim**:

> *"con Fletcher y todo, estuvo perfecto, el booking me gustó"*
>
