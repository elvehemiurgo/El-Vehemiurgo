...
tags: [danhausen, wwe-backlash-2026, gimmick-comico, entertainment-autosuficiente, perfect-wrestling, fighting-spirit, wrestling-entertainment, primer-registro-individual]
---

# Danhausen

> Primer registro individual del archivo. Con Minihausen vs The
> Miz & Kip en Backlash — triple clase, con el elogio de que
> **generan entretenimiento por cuenta propia**.

## Identificación

- **Nombre de gimmick**: Danhausen.
- **Nombre real**: [verif].
- **Empresa (2026)**: WWE.
- **Perfil**: gimmick cómico de personalidad muy marcada, con un
  acto construido y sostenido por el propio talent — el tipo de
  autosuficiencia que el Vehemiurgo destaca.
...
### Sesión 2026-07-14 s43 — "Entertainment por su cuenta", legítimamente brillante
...
**Lectura sintética**: triple clase. *"Están haciendo
entertainment por su cuenta"* es el núcleo del elogio — el acto no
depende del booking que lo rodea para generar su valor, que es
...
- [ ] Nombre real, debut, trayectoria completa (recorrido indie y
      AEW previo a WWE — pendiente catalogar).
- [ ] Origen y mecánica del acto "Danhausen".
- [ ] Relación exacta con Minihausen dentro del gimmick.
