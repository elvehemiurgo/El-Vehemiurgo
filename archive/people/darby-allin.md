...
> sorprendió al Vehemiurgo pese a no ser fan declarado de las
> luchas de ninguno de los dos.

## Identificación

- **Nombre de gimmick**: Darby Allin.
- **Nombre real**: [verif].
- **Empresa actual (2026)**: AEW.
- **Estilo**: high-risk / daredevil, presentación extrema
  (maquillaje, riesgo físico) [verif detalle específico 2026].
...
### Sesión 2026-07-14 s08 — Sorpresa: Perfect Match pese a no ser fan

**Cita verbatim**:

> *"Darby vs Tomasso realmente me sorprendió, no soy muy fan de
> las luchas de ambos, pero esta colisión fue muy creativa"*
>
> — El Vehemiurgo, 2026-07-14 s08 (verbatim)

**Lectura sintética**: el elogio pesa más por venir de una base de
