...
fuentes_principales:
  ...
  - "Menciones previas en la lista personal maestra (matches del 25/3, 4/3, 18/2 2026)"
tags: [clark-connors, the-guns-verif, aew, njpw, over-the-top, primer-take-individual]
---

# Clark Connors

> Primer take editorial individual — ya mencionado de pasada en
> la lista personal maestra (agrupado con David Finlay, Gabe
> Kidd, Orange Cassidy, Tomohiro Ishii en matches previos de
> 2026). Ahora protagonista destacado del rematch The Dogs vs The
> Guns como parte de **The Guns** [verif].

## Identificación

- **Nombre de gimmick**: Clark Connors.
- **Nombre real**: [verif].
- **Empresa actual (2026)**: AEW, con raíz NJPW.
- **Equipo**: The Guns [verif — identidad presumida por contexto,
  no confirmada].

## Trayectoria condensada

- **18/2/2026** — match junto a Gabe Kidd, Tomohiro Ishii y Orange
  Cassidy [pendiente].
- **4/3/2026** — match junto a Gabe Kidd, Darby Allin y Orange
  Cassidy [pendiente].
- **25/3/2026** — match junto a David Finlay, Roderick Strong y
  Orange Cassidy [pendiente].
...
### Sesión 2026-07-14 s22 — "Personaje over the top que me atrae mucho"

**Cita verbatim**:

> *"Connors vs Juice, son personajes over the top que me atraen
> mucho, son cool y tienen buenas promos"*
>
