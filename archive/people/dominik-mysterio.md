...
fuentes_principales:
  ...
  - "Ringside News — comentario sobre traición McDonagh ('step out of Finn's shadow')"
...
- **Nombre real**: Dominik Gutiérrez.
- **Nombres de gimmick**: Dominik Mysterio.
- **Familia**: hijo de Rey Mysterio. Vínculo storyline con Eddie
  Guerrero (kayfabe) — el "I'm your papá" angle (2005) lo precede
  como referencia kayfabe usada en su debut adulto.
- **Promoción actual (mayo 2026)**: WWE Raw, **líder de hecho de
  Judgment Day** post-expulsión de Bálor (9 mar 2026).

## Datos duros

- **Debut profesional WWE**: 2020.
- **Heel turn**: 2022, ataca a su padre Rey y se une a Judgment Day.
  **Uno de los heel turns más limpios y comerciales del periodo
  post-Reigns** — heat genuino y sostenido.
- **Judgment Day**: miembro fundador con Bálor, Damian Priest, Rhea
  Ripley.
- **Title runs relevantes**: pendiente lista (NXT North American, IC,
  otros).
- **Programa con Bálor en WrestleMania 42 (abr 2026)**: pierde.
- **Programa con McDonagh en Raw 4/20**: en post-match intenta
  *sneak attack* sobre Bálor que sale mal y debe retirarse.
...
- *Out of Character with Ryan Satin*, varios episodios.
- Apariciones mainstream USA / Mexico — figura crossover.

## Notas editoriales del Vehemiurgo

### Sesión 2026-05-09 — Falta evolución como main eventer
...
> "Dom ya debería haber evolucionado más, no solo físicamente sino
> como main eventer, la verdad debió ser más satisfactorio pero se
> sintió como mucho complementario al booking de Liv Morgan."

**Lectura**:
- El Vehemiurgo da por confirmado que **Dom evolucionó
  físicamente** pero **no como main eventer**.
- **Diagnóstico crítico**: la oficina lo ha mantenido como
  **complemento del run de Liv Morgan** en lugar de construirlo
  como top guy.
- **Lectura histórica**: el momentum de Dominik desde el heel turn
  2022 fue uno de los mejores del periodo post-Reigns. El
  Vehemiurgo lee que **la oficina lo dejó parar** y perdió la ola.
- **Línea editorial pendiente**: dónde se rompió la curva
  ascendente y por qué la oficina lo subordinó al run de Liv en
  2026.
