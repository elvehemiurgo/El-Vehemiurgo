...
> con background **amateur wrestling** legítimo. Cruzó al MMA temprano
> (Vale Tudo / PRIDE era) sin abandonar el pro wrestling. Entra al
> archivo por el tag match vs Ikeda/Yoneyama declarado **Fighting Spirit
> Class** (Vehemiurgo, 2026-06-17). Stub mínimo; expandir.
...
> *"fue muy buena, muy dura"*
>
> — El Vehemiurgo, 2026-06-17 (sobre el tag vs Ikeda/Yoneyama)

- Entra por dureza del tag (FS).
- **Por qué importa para el cluster**: Otsuka es el wrestler que
  **cruza la frontera** entre shoot-style worked y MMA real de la era.
  Encarna en una sola carrera el momento experimental pre-UFC/PRIDE
  consolidado que el Vehemiurgo señala.

## Pendientes / huecos

- [ ] Datos biográficos básicos.
- [ ] Record amateur wrestling pre-debut.
- [ ] Cronología BattlARTS + MMA cruces.
- [ ] **Fecha y show exactos del tag match** — ver match stub.
