...
> Primer registro individual del archivo. Parte del Perfect Match
> de apertura de AAA Worldwide junto a Zima Ion y Aerostar.
> Probablemente **Lince Dorado** [verif — el dictado solo dice
> "Lince"].

## Identificación

- **Nombre de gimmick**: Lince [verif si es Lince Dorado u otra
  variante].
- **Nombre real**: [verif].
- **Empresa (2026)**: AAA.
...
- **18/4/2026 (AAA Worldwide)** — vs Zima Ion y Aerostar (3 way,
  opener): Perfect Match (PW·FS·WE).
  ([→](../matches/2026-04-18-zima-ion-vs-lince-vs-aerostar-aaa-worldwide.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s38 — Parte del trío de apertura "super lujo"

**Cita verbatim**:

> *"muy buena lucha y muy oldschool, se merece las 3 clases, abrir
> el show con estos 3 pros es un super lujo"*
>
...
- [`./zima-ion.md`](./zima-ion.md) · [`./aerostar.md`](./aerostar.md)
