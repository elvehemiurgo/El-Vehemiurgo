---
nombre: "Jessy Jackson (Jessica Jackson)"
tipo: fact-sheet
categoria: people
slug: jessy-jackson
estado: vivo
...
fuentes_principales:
  ...
  - "Lista personal del Vehemiurgo (tag vs Las Tóxicas, 14/2/2026 — grafía 'JESSY JACKSON')"
tags: [jessy-jackson, jessica-jackson, aaa-2026, lucha-mexicana, perfect-wrestling, fighting-spirit, wrestling-entertainment, identidad-consolidada]
---

# Jessy Jackson (Jessica Jackson)

> **Corrección de identidad (2026-07-14 s43)**: registrada
> inicialmente como ficha suelta *"Jackson"*. El Vehemiurgo
> corrigió: *"Jackson de AAA es Jessica Jackson, la luchadora"* —
> **la misma que ya aparecía en su lista personal** en el tag del
...
- **Nombre de gimmick**: **Jessy Jackson** (grafía del archivo) /
  **Jessica Jackson** (grafía dictada por el Vehemiurgo en s43).
- **Nombre real**: [verif].
- **Origen**: México [verif].
- **Empresa (2026)**: **AAA**.
...
- **9/5/2026 (AAA Worldwide)** — vs La Catalina: Perfect Wrestling
  ...
  ([→](../matches/2026-05-09-la-catalina-vs-jessy-jackson-aaa-worldwide.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s42 — vs La Catalina: triple clase con reserva de estilo
...
podrían ser más old-school al recibir strikes, pero la ejecución
general fue "wrestling de calidad". Ver
...
- [`./la-catalina.md`](./la-catalina.md) — rival.
- ⚠ **No confundir con [`./jackson-drake.md`](./jackson-drake.md)**
  (WWE NXT, Vanity Project) — personas distintas.
