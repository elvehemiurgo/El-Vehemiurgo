...
> Primer registro individual del archivo. Estilo todavía
> experimental, pero que funciona por su selling destacable.

## Identificación

- **Nombre de gimmick**: Tatum Paxley.
- **Nombre real**: [verif].
- **Empresa (2026)**: WWE NXT.

## Trayectoria condensada

- **17/3/2026 (WWE NXT)** — vs Izzi Dame: sin clase declarada.
  ([→](../matches/2026-03-17-tatum-paxley-vs-izzi-dame-wwe-nxt.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s35 — Estilo experimental que funciona por el selling

**Cita verbatim**:

> *"Tatum pues sigue puliendo su estilo que quiere lograr, es
> experimental todavia, pero suele funcionar para mi por su
> selling destacable"*
>
> — El Vehemiurgo, 2026-07-14 s35 (verbatim)

**Lectura sintética**: primer registro individual — el Vehemiurgo
