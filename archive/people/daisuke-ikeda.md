...
> Worker del **shoot-style indie japonés mid-90s** — rama **BattlARTS**
> (post Fujiwara Gumi). Entra al archivo por el tag match Ikeda &
> Yoneyama vs Otsuka & Ishikawa que el Vehemiurgo calificó **Fighting
> Spirit Class** (2026-06-17). Stub mínimo; expandir.

## Identificación

- **Nombre**: **Daisuke Ikeda** (nombre real = gimmick).
- **Origen**: Japón.
- **Estilo**: **strong style / shoot-style indie** con vena BattlARTS —
...
> *"fue muy buena, muy dura, de verdad me dejó con ganas de ver más
> de esta generación"*
>
> — El Vehemiurgo, 2026-06-17 (verbatim)

- Entra por **dureza** (FS) y por abrir la vena editorial de la
  **generación junior heavyweight highspeed japonesa 1990s** — aunque
  BattlARTS es shoot-style más que highspeed puro, el Vehemiurgo lo
  agrupa con el cluster del paquete temporal 90s japonés.
- Candidato a aparecer en futuras investigaciones del cluster.

## Pendientes / huecos

- [ ] Datos biográficos básicos (nacimiento, escuela, debut exacto).
- [ ] Cronología BattlARTS + apariciones cross-promo.
- [ ] Tag teams signature con fechas.
- [ ] **Fecha y show exactos del tag match vs Otsuka/Ishikawa** —
      confirmar BattlARTS u otra empresa.
