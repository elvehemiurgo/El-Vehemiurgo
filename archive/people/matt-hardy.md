...
> **Héroe Fundamental #19 del Vehemiurgo** (línea *daredevil /
> longevidad carny*). En TNA 2026 es **el techo del mic**: *"los
> demás tratan de alcanzarlo"* y no lo alcanzan. Mitad de los
> Hardys — la plataforma-mentor que eleva actos (The System, The
> Righteous) en el ring **y** en la promo.
...
### Sesión 2026-07-05 s02 (adenda) — El techo del mic
...
1. **Jerarquía verbal declarada** — en el árbol de aprendizaje de
   promos de TNA (sesión #10), Matt no es rama: es la copa. El
   roster entero persigue su nivel.
2. Coherente con su línea de panteón: la longevidad carny no es
...
- [ ] Cronología exacta de la etapa Broken y la actual.
...
- [`./jeff-hardy.md`](./jeff-hardy.md) — hermano, DIOS DEL
  WRESTLING #5 (Tier 1).
