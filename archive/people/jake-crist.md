...
> fundacional del Tier 0, 2026-08-01 s23 — declarado viendo CZW
> Awakening 2017, primera sesión VEHEMIURGIA).

## Identificación

- **Escuela de Ohio / OI4K**, hermano de Dave Crist. En la ventana
  CZW 2017-2018: la faceta **"Prince"** — excéntrico, full gimmick.

## Notas editoriales del Vehemiurgo

### Sesión 2026-08-01 s23 — "Full wrestler", uno de mis favoritos

**Cita verbatim**:

> *"Jake Crist en su faceta de Prince, este tipo es una estrella,
> excéntrico, buenos movimientos, buena ejecución, full gimmick, es un
> wrestler, full wrestler, lleno de problemas personales y adicciones,
> muy buen estilo, muy afilado, un poco débil en el micrófono, pero
> completamente coacheable; es uno de mis favoritos, definitivamente
> me encanta su idea de wrestling, y me encanta ver que sigue
> trabajando duro"*
>
> — El Vehemiurgo, 2026-08-01 s23 (verbatim)

**Lectura sintética**: **WE** para su tramo de Awakening (14/1/2017),
con el "beso OI4K" dejando preguntas abiertas [detalle en research].
Nota de seguimiento declarada: su versión actual, madura y más
heavyweight, *"luce genial — queda pendiente revisar sus luchas"*.

### Sesión 2026-08-01 s26 — "Con sentido", y la excepción nombrada entre los Rascalz

**Citas verbatim**:

> *"OI4K los hermanos Crist ahora full OVE IMPACT WRESTLING SUPER
> STARS en tag team action [...] ADemás Jake Crist hace una flying
> cutter muy cool y con sentido."*
>
...
**Lectura sintética**: dos registros distintos en la misma sesión.

1. **El detalle técnico**: *"una flying cutter muy cool y **con
   sentido**"*. La segunda mitad es la que importa — el archivo ya
   tiene registrada la marca de fábrica de los Crist (*"flying
   cutters, y2k nu metal"*, panteón Tier 0), y acá se ratifica el
   criterio: el movimiento vale por su lugar en la secuencia, no por
   sí mismo.
2. **La excepción nombrada**: en el derrame editorial contra los
   Rascalz actuales, Jake Crist es uno de los dos talentos que el
   Vehemiurgo salva. Los dos ya están en el **Tier 0** — Jake desde la
...
- Con Dave, *"dos completos locos innovadores que forjaron su propio
  estilo con trabajo duro, adicciones y todos los problemas posibles
  encima"*. [Doctrina](../topics/doctrina-y2k-highspeed.md), [panteón](../topics/panteon-y2k-highspeed.md).

## Pendientes / huecos

- [ ] **Revisar las luchas de la versión actual (madura/heavyweight)
      de Jake Crist** — pendiente declarado por el Vehemiurgo.
- [ ] Detalle del ángulo del beso OI4K en Awakening.
- [ ] Cronología de carrera completa (OI4K, oVe en Impact, títulos).

## Piezas relacionadas

- [`dave-crist.md`](./dave-crist.md) · [`sami-callihan.md`](./sami-callihan.md)
