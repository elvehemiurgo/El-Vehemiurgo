...
fuentes_principales:
  ...
  - "El Vehemiurgo, notebook 2026-05-09 + take 2026-05-10"
---
...
- **Nombres de gimmick**: Blake Monroe.
- **Origen**: pendiente verificar.
- **Promoción actual (mayo 2026)**: WWE NXT.
- **Característica central**: heel reciente NXT con doble registro
  según lectura editorial del Vehemiurgo — *oficio in-ring para
  secuencias difíciles* + *character work entertainment de alto
  nivel*. **Eleva el producto.**

## Datos duros

- **Debut WWE NXT**: pendiente fecha exacta. Vignette anuncio
  *"The Glamour. Coming Soon."* en SmackDown 24 abr 2024 según
  notebook list — pero esa entrada parece referirse al call-up
  potencial al main roster (no debut NXT). **Verificar
  cronología NXT.**
- **Match notable abr 2026**:
  - **04 abr 2026 — NXT Stand & Deliver**: Tatum Paxley vs Blake
    Monroe (singles).
  - **07 abr 2026 — NXT TV semanal (presunción)**: tag mixto
    con Jackson Drake vs Shyloh & Tatum Paxley. **Multi-clase
...
- **Segmento notable**: alianza heel por conveniencia con The
  Vanity Project en NXT TV 7 abr 2026 — **Wrestling Entertainment
  Class asignada**, ejemplo canónico de la clase. Detalle en
...
### Sesión 2026-05-10 — "Eleva el producto" — secuencias difíciles + entertainment

**Cita verbatim del Vehemiurgo**:

> "Blake es muy buena para secuencias difíciles y Entertainment
> así, eleva mucho el producto."
...
- **Doble dimensión documentada del oficio de Blake**:
  - **"Secuencias difíciles"** = oficio in-ring técnico de alto
    nivel. Capacidad de ejecutar coreografías complejas con
    limpieza.
  - **"Entertainment así"** = character work + presence + carisma
    que sostiene el lado spectacle.
  - **No es uno o el otro — son ambos**. Esta es lectura
    editorial fuerte porque la mayoría del roster excepcional
    cumple un eje, no los dos.
- **"Eleva el producto"** — la pieza diferencial. El Vehemiurgo
  identifica a Blake como talent que **mejora todo lo que toca**.
  Es lectura categórica: no es "buena en su lane", es
  "transferible y multiplicadora".
- **Implicación operativa para la base**: cualquier match donde
  Blake aparezca tiene **alto potencial de multi-clase** según
  el rol que ejerza. La sesión 2026-05-10 ya documenta dos
  ...
  - Tag con Drake vs Shyloh/Paxley NXT 7 abr →
    **Perfect Wrestling + Wrestling Entertainment Class**.

**Línea editorial fértil**: pieza específica sobre **Blake Monroe
como caso 2026 de talent NXT que cumple la doble dimensión
oficio + entertainment** — material editorial para distinguir
...
- [ ] Origen / background pre-WWE.
- [ ] Fecha exacta de debut NXT.
- [ ] Faction / stable affiliation actual (alianza por conveniencia
      con Vanity Project documentada en segmento del 7 abr —
      verificar si es alianza fija o puntual).
- [ ] Run NXT 2025-2026 completo (mín. 6+ entries en notebook a
      procesar).
- [ ] Datos contractuales.
