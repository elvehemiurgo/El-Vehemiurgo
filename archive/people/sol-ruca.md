...
fuentes_principales:
  - "Wikipedia — Sol Ruca"
  - "Cagematch — Sol Ruca"
  - "Fox News Digital — entrevistas pre-Stand & Deliver y post-Revenge"
  - "Insight with Chris Van Vliet — entrevista de despedida a NXT (sin transcripción pública)"
  - "Cobertura PWTorch / 411mania / Slam Wrestling / TJR Wrestling — NXT 2024–2026"
...
- **Nombres de gimmick**: Sol Ruca.
- **Promoción actual (mayo 2026)**: WWE main roster (Raw) — call-up
  desde NXT post-NXT Revenge 21 abr 2026.
- **Lugar previo**: WWE NXT (varios años).
- **Background atlético**: gimmick *surfista californiana*; se asocia
  con cultura beach / surf como armadura visual.
- **Finisher**: *Sol Snatcher* (springboard X-Factor).

## Datos duros

- **Debut profesional**: pendiente confirmar.
- **Entrenamiento**: WWE Performance Center.
- **Promociones**: WWE NXT → WWE Raw (mayo 2026).
- **Títulos relevantes**:
  - Ex-NXT Women's North American Champion. *(Pendiente fechas y
    duración del run.)*
  - Ex-NXT Women's Speed Champion. *(Pendiente fechas.)*

## Contexto financiero / contractual conocido

- Pendiente — ver si la investigación
  [`tko-contracts-2025-2026`](../../research/pending.md) trae datos
  específicos sobre call-ups recientes (Sol entra al main roster
  durante el periodo cubierto).
...
- **Fox News Digital** — pre-Stand & Deliver 2026 (artículo *"WWE
  NXT star Sol Ruca readies for emotional match against Zaria at
  Stand & Deliver"*). Contiene cita on-record sobre el frame
  kayfabe-shoot del feud con Zaria.
- **Fox News Digital** — *"WWE's Sol Ruca content with NXT for as
  long as management needs her"*. Declaración de estancia en NXT,
  pre-call-up.
- **Fightful** — *"Sol Ruca: Thank You NXT, It's Been Real"*
  (post-Revenge 21 abr 2026; tono de despedida).
- **Insight with Chris Van Vliet** — episodio de despedida a NXT
  referenciado en redes oficiales, sin transcripción pública
  indexada. **Pendiente** escucha humana.

## Notas editoriales del Vehemiurgo

### Sesión 2026-05-09 — Sol como babyface principal del NXT 2026
...
**Lectura**:
- El Vehemiurgo posiciona a Sol como **babyface principal** de un
  NXT 2026 dominado en otros frentes por Jacy Jayne y Fatal
  Influence.
- *"Trascendiendo NXT"* — el call-up al main roster (post-Revenge
  21 abr 2026 → Raw 5 may 2026 con feud Liv Morgan + interferencia
  Zaria) lo confirma. Sol cruza el techo de NXT al main roster
  cargando el feud personal.
- **Implicación editorial**: Sol es el **caso ejemplar 2026** de
  babyface NXT que sale por la puerta grande. Material para escribir
  sobre el patrón "salida de NXT con storyline atado" como técnica
  carny.

**Distribución cruzada**: ver también
...
(Pendiente — se escribirá cuando haya masa crítica de notas para una
pieza editorial. Material de partida actual: la sección 1 del
...
- [ ] Fecha y duración del run como NXT Women's North American
      Champion.
- [ ] Fecha y duración del run como NXT Women's Speed Champion.
- [ ] Trayectoria pre-NXT (debut, entrenamiento, deportes previos —
      hay backround atlético acuático que abre línea).
- [ ] **Datos contractuales del call-up al main roster post-Revenge
      21 abr 2026** — esperar retorno del sub-agente
      `tko-contracts-2025-2026`.
- [ ] Escucha humana de la entrevista de despedida en *Insight*.
- [ ] Reacciones in-arena al call-up (Raw 5 may 2026).
