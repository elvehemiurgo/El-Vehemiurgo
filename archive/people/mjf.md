---
nombre: "MJF (Maxwell Jacob Friedman)"
tipo: fact-sheet
categoria: people
slug: mjf
estado: vivo
...
tags: [mjf, maxwell-jacob-friedman, aew-world-champion, cm-punk-feud-2022, dog-collar-match-2022, hangman-feud-2026, modern-heel-old-school, devil-mask-storyline]
---

# MJF (Maxwell Jacob Friedman)

> **Modern heel old-school** — character work carny puro
...
- **Nombre real**: Maxwell Jacob Friedman.
- **Origen**: Plainview, New York. 15 mar 1996.
- **Edad activo**: 30 años (mayo 2026).
- **Status actual**: AEW main eventer, current run heel reset
  2026.
- **Finisher signature**: ***Heatseeker*** (piledriver), ***Salt
  of the Earth*** (cross-armbreaker), ***Diamond Ring punch***
  (loaded ring strike).
- **Apodo**: *Wrestling's Biggest Superstar of Tomorrow*,
  *The Devil*, *Better Than You and You Know It*.

## Trayectoria condensada

- **Indies 2015-2018**: indies USA northeast, MLW (Major League
  Wrestling) primer signing meaningful.
- **AEW founding 2019**: signed mid-2019, run heel mid-card →
  upper.
- **MJF vs Cody Rhodes 2019-2020** — primer feud establece
  character work + storyline carny.
- **Inner Circle vs Pinnacle 2021** (MJF leads Pinnacle vs
  Jericho's Inner Circle) — faction vs faction.
- **MJF vs CM Punk feud 2021-2022** — peak storyline. **Pieza
  editorial central**:
  - **AEW Revolution 6 mar 2022 Dog Collar Match** — pieza
    Batch 6 documentada
...
- **MJF turn babyface ago 2022** post-Punk loss + working
  contract negotiation worked-shoot meta.
- **AEW World Champion 2022-2023** — primer reign extended
  babyface run.
- **The Devil mask storyline 2023-2024** — heel masked attacker
  (revealed eventual MJF mask). Carny puro mystery storyline.
- **2026 cluster — feud Hangman Adam Page**:
  - 18.02.2026 Dynamite: MJF and Hangman segment.
  - 25.02.2026: MJF in-ring segment with Hangman.
  - 04.03.2026: MJF vs Kevin Knight + MJF promo with Hangman.
  - 11.03.2026: MJF vs Hangman Revolution promo + press
    conference.
  - **15.03.2026 AEW Revolution**: MJF vs Hangman blow-off PPV.
  - 25.03.2026 Dynamite: MJF promo first half post-Revolution.

## Notas Vehemiurgia

- **Modern heel old-school carny puro**: MJF combina **promos
  verbosos heel character work** (legacy Roddy Piper +
  Cornette manager-self) + **ring work workmanlike** + **booking
  awareness** del propio talent.
- **CM Punk feud 2021-2022 Dog Collar** = pieza editorial
  obligatoria. Cornette-school respeta el dog collar como
  homenaje Starrcade 1983 Valentine/Piper.
...
### Sesión 2026-07-14 s25 — Apertura DCMJF: "dijo cosas interesantes"

**Cita verbatim**:

> *"el show abre con un gran segmento con DCMJF todos los heels,
> y me gustó la participación de todos, MJF sí dijo cosas
> interesantes, está muy intenso todo el team [...] este segmento
> se merece el entertainment class"*
>
> — El Vehemiurgo, 2026-07-14 s25 (verbatim)

**Lectura sintética**: Wrestling Entertainment compartida con el
resto de la coalición heel — MJF sigue rindiendo contenido de peso
