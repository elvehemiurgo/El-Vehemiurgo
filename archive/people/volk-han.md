...
> El **ruso técnico** de **Fighting Network RINGS** — Combat SAMBO
> hibridado con shoot-style worked japonés. Master de las **rolling
> kneebars** y las transiciones técnicas improbables. Frontman extranjero
> del roster Akira Maeda en los 90s. Candidato fuerte al panteón del
> Vehemiurgo tras el match vs Tamura 25 sep 1996 (triple clase).
...
- Aparece en el archivo por el match vs **Kiyoshi Tamura, RINGS
  25/9/1996** — declarado **obra maestra triple clase** + el match
  inaugura la **trilogía Han vs Tamura** (las tres triple clase a
  priori). Ver
  [`../topics/volk-han-vs-kiyoshi-tamura-trilogia-rings.md`](../topics/volk-han-vs-kiyoshi-tamura-trilogia-rings.md).
- **Por qué importa**: Volk Han es la prueba de que el shoot-style
  worked puede absorber un background atlético genuino (SAMBO) sin
  romperse. El **híbrido funciona** — y eso solo es posible cuando
  hay un partner como Tamura que sabe responder con ortodoxia.
