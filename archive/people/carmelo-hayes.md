...
tags: [carmelo-hayes, wwe-smackdown-2026, perfect-wrestling, fighting-spirit, wrestling-entertainment, oldschool, primer-registro-individual]
---

# Carmelo Hayes

> Primer registro individual con desarrollo propio, pese a
> aparecer ya en la lista personal del Vehemiurgo. Entra al
> archivo con un **Perfect Match** contra Ricky Saints.

## Identificación

- **Nombre de gimmick**: Carmelo Hayes.
- **Nombre real**: [verif].
- **Empresa (2026)**: WWE SmackDown.

## Trayectoria condensada (por fecha de show)

- **13/2/2026 (WWE SmackDown)** — 10-man tag con Nakamura,
  Cardona, Dragunov y Crews vs MFTs [pendiente registro completo].
- **27/2/2026 (WWE SmackDown)** — vs Matt Cardona [pendiente
  registro completo].
- **15/5/2026 (WWE SmackDown)** — vs Ricky Saints: **Perfect
  Match** (PW·FS·WE).
  ([→](../matches/2026-05-15-carmelo-hayes-vs-ricky-saints-wwe-smackdown.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s48 — Perfect Match vs Ricky Saints: "le metieron muy oldschool"
...
**Lectura sintética**: entra al archivo por la puerta grande —
Perfect Match, con el elogio de que **el tropiezo no rompió la
