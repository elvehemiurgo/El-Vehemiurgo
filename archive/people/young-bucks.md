---
nombre: "Young Bucks (Matt & Nick Jackson)"
tipo: fact-sheet
categoria: people
slug: young-bucks
estado: stub
...
- **Indies / PWG / ROH / NJPW 2010s** — tandem revolucionó el
  tag wrestling indie moderno. **IWGP Junior Tag + ROH Tag
  múltiples** [verif].
- **Bullet Club / The Elite** (NJPW) — núcleo del movimiento
  que derivó en AEW.
- **Being The Elite (BTE)** — YouTube show, motor del proyecto
  pre-AEW.
- **AEW founding 2019** — **fundadores + EVP (Executive Vice
  Presidents)** + AEW World Tag Team Champions múltiples
  [verif].
- **2026** — **dos Perfect Match en la sesión del Vehemiurgo**:
...
### Notebook 2026-05-26 — héroes fundamentales (verbatim)

> *"amo a los young bucks, son mis héroes también [...] esta
> lucha [vs Okada & Takeshita] merece las 3 clases, fue
> increíble, y el Booking es realmente atrayente."*

### Lectura — el panteón y el matiz Vehemiurgia

- **DECLARACIÓN DE HÉROES FUNDAMENTALES** — el Vehemiurgo los
  suma a su panteón (*"también"*), junto a figuras ya
  declaradas: Christian Cage, CM Punk, Mark Rocco, Roderick
  Strong (ver [`./roderick-strong.md`](./roderick-strong.md)).
- **Matiz editorial importante**: los Young Bucks son el
  **tandem moderno superkick-era** — a primera vista el opuesto
  del **panteón de workers de oficio old-school** (Rocco,
  Roderick). Que sean héroes del Vehemiurgo **igual** confirma
  que su criterio **no es nostalgia anti-moderna**: los Bucks
  se ganan el lugar porque, para él, tienen **intención carny +
  booking awareness + draw**, no solo movimientos. *"El booking
  es realmente atrayente"* — la clave Vehemiurgia: el spectacle
...
- [ ] Trayectoria detallada: PWG/ROH/NJPW reinos + AEW Tag
      Title reigns con fechas.
- [ ] The Elite + BTE — pieza editorial sobre el proyecto que
      derivó en AEW.
...
- [`../matches/2026-04-11-young-bucks-vs-hechicero-clon-aew-collision.md`](../matches/2026-04-11-young-bucks-vs-hechicero-clon-aew-collision.md)
  — Perfect Match (las tres clases).
- [`../matches/2026-03-15-young-bucks-vs-ftr-aew-revolution.md`](../matches/2026-03-15-young-bucks-vs-ftr-aew-revolution.md)
  — vs FTR Revolution 2026.

### Panteón de héroes del Vehemiurgo (cross-links)
- [`./christian-cage.md`](./christian-cage.md)
- [`./cm-punk.md`](./cm-punk.md)
- [`./mark-rocco.md`](./mark-rocco.md)
- [`./roderick-strong.md`](./roderick-strong.md)
