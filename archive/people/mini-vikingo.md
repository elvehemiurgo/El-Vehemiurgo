...
> Primer registro individual del archivo. Rival de grudge match
> contra Hijo del Vikingo — triple clase compartida, selling "de
> otro nivel" según el Vehemiurgo.

## Identificación

- **Nombre de gimmick**: Mini Vikingo.
- **Nombre real**: [verif].
- **Empresa (2026)**: AAA.
- **Característica central**: mini-estrella con selling de alto
  nivel, capaz de sostener una grudge match de calidad de main
  event contra Hijo del Vikingo.

## Trayectoria condensada

- **2/5/2026 (AAA Worldwide)** — vs Hijo del Vikingo: Perfect
  Wrestling + Fighting Spirit + Wrestling Entertainment.
  ([→](../matches/2026-05-02-hijo-del-vikingo-vs-mini-vikingo-aaa-worldwide.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s41 — Grudge match brutal, triple clase
...
> brutal con mucha calidad"*
>
> — El Vehemiurgo, 2026-07-14 s41 (verbatim)

**Lectura sintética**: triple clase — grudge match con historia
intensa y booking "bien curado". El selling de ambos descrito como
...
- [ ] Naturaleza exacta del "grudge" con Hijo del Vikingo.
