...
tags: [ec3, ethan-carter-iii, tna-2013-2018, dixie-carter, control-your-narrative, nwa, regreso-2026, cleveland, doctrina-gimmick-en-su-contexto]
---

# EC3

> **Michael Hunter Hutter**, n. 18/3/1983, de Cleveland, Ohio. En TNA
> (2013-2018) fue **Ethan Carter III**, sobrino kayfabe de **Dixie
> Carter**, heel de sangre azul con un invicto largo y la catchphrase
> *"trouble, trouble, trouble"* — **dos veces campeón mundial**.
> Regresa a un ring de TNA por primera vez desde 2020, en Rebellion
> 2026, en su ciudad natal.

## Identificación

- **Nombre de gimmick**: EC3 (Ethan Carter III en TNA original).
- **Nombre real**: **Michael Hunter Hutter**, n. 18 de marzo de 1983.
- **Procedencia**: zona de Cleveland, Ohio.
- **Empresa (abril 2026)**: TNA Wrestling.

## Trayectoria condensada

- **WWE, primera etapa** — como **Derrick Bateman** (NXT/desarrollo);
  sale de WWE en mayo de 2013.
- **TNA (2013-2018)** — debuta como **Ethan Carter III (EC3)**,
  sobrino kayfabe de Dixie Carter (dueña de TNA). Heel de sangre azul
  alimentado a jobbers con un invicto largo, catchphrase *"trouble,
  trouble, trouble"*. **Dos veces campeón mundial TNA** [detalle de
  fechas y rivales — verif].
- **WWE (2018-2020)** — segunda etapa (NXT y roster principal), leído
  por la cobertura como mal utilizado.
- **Post-WWE** — funda **Control Your Narrative** (promotora/proyecto
  propio, junto a Adam Scherr); **NWA desde 2022** (campeón mundial
  NWA); pasos por **ROH**; regresos puntuales a Impact/TNA.
- **11/4/2026, TNA Rebellion (Cleveland, Ohio)** — regresa a un ring
  de TNA por primera vez desde 2020, en su ciudad natal. Ver
...
- **16/4/2026, iMPACT!** — primer match del regreso, vs Eric Young:
  **no contest a los 2:05** (emboscada en la entrada, brawl a la
  rampa, EC3 manda a Young y al réferi por encima de la tercera
  cuerda con un clothesline; post-match Young le envuelve una silla en
  el cuello tras un chairshot fallado de EC3 contra el poste).

## Notas editoriales del Vehemiurgo

### Sesión 2026-08-01 s40 — El regreso: "Ethan fuera de TNA es raro y cringe, pero EC3 es cool"

**Cita verbatim**:

> *"luego regresa EC3, pero el TNA EC3, fue buena idea setearlo con EY
> que habló de Dixie y todo el gimmick EC3, porque Ethan fuera de TNA
> es raro y cringe, pero EC3 es cool, es histórico, es trouble trouble
> trouble, se merecen una WE class"*
>
> — El Vehemiurgo, 2026-08-01 s40 (verbatim)

**Lectura sintética**: **WE**, compartida con el segmento de Eric
Young. **La pieza doctrinal central de su ficha**: el gimmick de EC3
**solo funciona dentro del mundo de TNA que lo originó** — fuera de
ahí (como "Ethan" suelto) el Vehemiurgo lo lee como *"raro y
cringe"*. La aprobación de booking es explícita: setearlo con Eric
Young invocando a Dixie Carter y el gimmick entero antes de que
aparezca es la decisión correcta, porque reconstruye el contexto que
...
- [ ] Detalle completo del run 2013-2018 (feuds, invicto, caída del
      invicto).
- [ ] Trayectoria completa 2018-2026 fuera de TNA (Control Your
      Narrative, NWA, ROH) — solo esbozada por research.
- [ ] Seguimiento del feud vs Eric Young tras el no contest del 16/4.

## Piezas relacionadas

- [`../people/eric-young.md`](../people/eric-young.md)
- [`../segments/2026-04-11-eric-young-promo-regreso-ec3-tna-rebellion.md`](../segments/2026-04-11-eric-young-promo-regreso-ec3-tna-rebellion.md)
