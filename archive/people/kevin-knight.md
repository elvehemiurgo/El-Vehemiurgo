...
- **Nombre de gimmick**: Kevin Knight.
- **Nombre real**: [verif].
- **Empresa actual (2026)**: AEW.

## Trayectoria condensada

- **29/4/2026 (AEW Dynamite)** — vence a MJF por low blow, upset.
  ([→](../matches/2026-04-29-mjf-vs-kevin-knight-aew-dynamite.md)).

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s09 — El upset

**Cita verbatim**:

> *"MJF le da la lucha de su vida a Kevin Knight [...] ahora MJF
> recibe el pin después de un low blow, tremendo upset para
> Kevin"*
>
> — El Vehemiurgo, 2026-07-14 s09 (verbatim)

**Lectura sintética**: MJF, como top heel, presta su estatus para
darle a Kevin Knight el mejor match de su carrera y una victoria
