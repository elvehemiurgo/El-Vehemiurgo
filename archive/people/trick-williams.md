...
tags: [trick-williams, wwe-smackdown-2026, mic-work, wrestling-entertainment, el-negocio-personificado, primer-registro-individual]
---

# Trick Williams

> Primer registro individual con desarrollo propio, pese a
> aparecer varias veces en la lista personal del Vehemiurgo desde
> enero 2026 (rivalidad con Rey Fénix, luego con Jacob Fatu). Doble
> Wrestling Entertainment en la misma sesión — un momento de ring
> puntual y una promo backstage completa.

## Identificación

- **Nombre de gimmick**: Trick Williams.
- **Nombre real**: [verif].
- **Empresa (2026)**: WWE SmackDown.
- **Característica central declarada por el Vehemiurgo**: *"es el
  negocio personificado"* — mic work de primer nivel.

## Trayectoria condensada

- **1/5/2026 (WWE SmackDown)** — segmento con "the gingerbread
  man": Wrestling Entertainment.
  ([→](../segments/2026-05-01-trick-williams-gingerbread-man-wwe-smackdown.md)).
- **1/5/2026 (WWE SmackDown)** — promo backstage: Wrestling
  Entertainment.
  ([→](../segments/2026-05-01-trick-williams-promo-backstage-wwe-smackdown.md)).
- (Pendientes de registro completo: vs Rey Fénix 09/01 y
  13/02/2026, backstage con Jacob Fatu y Nick Aldis 13/03/2026, vs
  Jacob Fatu 13/03/2026, backstage con Sami Zayn 20/03/2026.)

## Notas editoriales del Vehemiurgo

### Sesión 2026-07-14 s41 — Doble Wrestling Entertainment: el gingerbread man y la promo backstage

**Cita verbatim** (segmento del gingerbread man):

> *"el segmento de Trick con el ginger bread man, estuvo ok, pero
> lo que merece una enterteinment class es especificamente Trick
> throwing the X for the ginger bread man dismanteled in the ring,
> just wrestling"*
>
> — El Vehemiurgo, 2026-07-14 s41 (verbatim)

**Cita verbatim** (promo backstage):

> *"la promo backstage de Trick estuvo genial, es el negocio
> personificado, top tier promo, se merece el enterteinment
> class"*
>
> — El Vehemiurgo, 2026-07-14 s41 (verbatim)
...
1. **Clase quirúrgica sobre un momento específico**: el
   Vehemiurgo distingue el segmento general ("estuvo ok") del
   momento puntual que sí merece la clase — Trick tirando el X
   para desarmar al gingerbread man en el ring, calificado de
   *"just wrestling"*.
2. **Promo backstage — veredicto máximo de mic work**: "el negocio
   personificado" es uno de los elogios más fuertes que el
   Vehemiurgo reserva para talento de mic — comparable a los
