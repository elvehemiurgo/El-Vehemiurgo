...
> **Babyface TNA Knockouts X-Division en singles run 2025-2026**.
> Ex-**The Rascalz** (con Wentz y Dezmond Xavier). *"Babyface
> cool, un poco cringe a veces, pero es sólido"* según el
> Vehemiurgo (2026-06-17 #12) — declarado **rama promesas del
> árbol de aprendizaje en mic TNA 2026**.
...
- **Empresa actual (2026)**: TNA Wrestling — X-Division / main
  scene singles.
- **Equipo previo**: ***The Rascalz*** (con Wentz y Dezmond Xavier),
  TNA 2018-2021.

## Trayectoria condensada

- **Indies USA + AAW** + cross-promo CMLL.
- **TNA / Impact Wrestling 2018-presente**: The Rascalz era
  + brief WWE NXT (2020-2021 con Wentz como MSK con Zachary
  Wentz + Nash Carter, ganaron NXT Tag Title).
- **TNA regreso post-WWE 2022+**.
- **2025-2026 — singles run**:
  - **4 dic 2025 (Impact)** — Trey Miguel vs Mustafa Ali.
  - **5 feb 2026 (Impact)** — Trey Miguel vs Brookes [Jensen?].
  - **The Rascalz** activo paralelo (vs The System Turning Point
    14 nov 2025).

## Notas editoriales del Vehemiurgo

### Sesión 2026-06-17 #12 — *"babyface cool, un poco cringe, pero sólido"*

> *"Trey Miguel es un babyface cool, un poco cringe a veces, pero
> es sólido"*
>
...
1. ***"Babyface cool"*** — reconocimiento positivo: Trey funciona
   como face en 2026.
2. ***"Un poco cringe a veces"*** — **diagnóstico honesto**: hay
   momentos donde el acto se va al exceso. Pieza editorial al
   horno: *"El cringe babyface — qué lo distingue del babyface
   bien hecho"*.
...
- [ ] Cronología completa Rascalz (2018-2021 TNA / NXT MSK 2020-2021
      / TNA regreso 2022+).
- [ ] Championships TNA X-Division + tag titles.
- [ ] Apertura matches del cluster Trey 2025-2026 (3 entradas).
- [ ] Identificar concretamente **qué cringes** (segments / promos
      específicos) generaron el matiz del Vehemiurgo.

## Cross-links

- [`../topics/tna-2026-arbol-de-aprendizaje-en-mic.md`](../topics/tna-2026-arbol-de-aprendizaje-en-mic.md)
  — **rama promesas del árbol** (Rama 3).
- [`../people/mustafa-ali.md`](../people/mustafa-ali.md) — match
  vs Trey 4 dic 2025.
