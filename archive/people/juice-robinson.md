...
> establecida en esa órbita.

## Identificación

- **Nombre de gimmick**: Juice Robinson.
- **Nombre real**: [verif].
- **Empresa actual (2026)**: AEW, con raíz NJPW/Bullet Club.
- **Equipo**: The Dogs [verif — identidad presumida por contexto].
...
### Sesión 2026-07-14 s22 — "Muy bueno en el ring"

**Cita verbatim**:

> *"Connors vs Juice, son personajes over the top que me atraen
> mucho, son cool y tienen buenas promos, además de que Juice es
> muy bueno en el ring"*
>
...
- [`./the-dogs.md`](./the-dogs.md) · [`./clark-connors.md`](./clark-connors.md)
