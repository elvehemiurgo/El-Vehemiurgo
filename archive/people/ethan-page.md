...
- **Nombres de gimmick**: Ethan Page (también *"All Ego"* en
  AEW).
- **Promoción actual (mayo 2026)**: WWE main roster (Raw),
  call-up post-WrestleMania 42 según
  [`topics/tko-contracts-2025-2026.md`](../topics/tko-contracts-2025-2026.md).
- **Trayectoria larga**: indie circuit 2010s → Impact Wrestling
  → AEW 2020-2024 → WWE NXT 2024-2026 → main roster.

## Datos duros

- **Debut profesional**: 2007 ish, indie canadiense.
- **AEW**: 2020-2024 con gimmick *"All Ego"*. Salió a WWE NXT.
- **WWE NXT**: ex-NXT Champion. Pieza central del main event NXT
  2025-2026 — el "triángulo" con Ricky Saints y Joe Hendry según
  lectura editorial del Vehemiurgo.
- **WWE main roster (Raw)**: debut 20 abr 2026 (Raw After
  WrestleMania 42), match con Jevon Evans según
...
- Múltiples en su run AEW (*Insight with Chris Van Vliet*,
  *Talk Is Jericho*, su propio podcast). Pendiente catalogar.
...
**Lectura sintética sobre Ethan**:

- **Booking diferente al de Ricky y Joe**: el triángulo funciona
  porque **no son intercambiables**. Ethan trae su propio recorrido
  (AEW pedigree + heel work refinado).
- **Coincidencia en el main event de NXT como evento
  catalizador**: la oficina los puso a competir y la chispa
  funcionó.
- **"Cargaron, rindieron y vendieron un gran año de rivalidades"**:
  los tres verbos del oficio. Ethan participó de los tres en su
  rol específico.
- **Proyección post-NXT a SmackDown y Raw**: paralelismo con
  Fatal Influence — call-ups que **mantienen el peso editorial
  que tenían en NXT**.
- **"El presente del wrestling"**: veredicto editorial. Junto con
  Ricky y Joe, son la cohorte que define el momento.

**Sobre el finish del 8-man tag**: el Vehemiurgo destaca
*"lo de Ethan y todo, estuvo increíble"* — Ethan tuvo
...
- [ ] Composición y rol exacto en el Vanity Project NXT.
- [ ] Run main roster post 20 abr 2026 — matches y angles.
