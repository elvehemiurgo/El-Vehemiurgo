...
> El **shoot-style worker más puro** de su generación. Alumno
> **UWF/UWF-i** (escuela Maeda/Takada) que pasa a **Fighting Network
> RINGS** y sostiene la **trilogía vs Volk Han** declarada Perfect
> Match en bloque por el Vehemiurgo (triple clase para los tres
> matches). Candidato fuerte al panteón.

## Identificación

- **Nombre real**: **Kiyoshi Tamura** (nombre real = gimmick — no
  máscara, no gimmick reinventado).
- **Origen**: Japón. [verif fecha y ciudad nacimiento].
- **Estilo**: **shoot-style ortodoxo** — control absoluto del ritmo,
  selling técnico, dramaturgia de submission y striking medido.
...
- Aparece en el archivo por el match vs **Volk Han, RINGS 25/9/1996**
  — declarado **obra maestra triple clase** + parte de la **trilogía
  Han vs Tamura** (las tres triple clase a priori). Ver
  [`../topics/volk-han-vs-kiyoshi-tamura-trilogia-rings.md`](../topics/volk-han-vs-kiyoshi-tamura-trilogia-rings.md).
- **Por qué importa**: Tamura es el **partner ortodoxo** que hace
  posible el cruce con la creatividad de Han. Sin un técnico puro del
  otro lado, la creatividad SAMBO de Han se cae. Tamura **sostiene la
  conversación**.
- **Candidato al panteón**: pendiente declaración del Vehemiurgo.
