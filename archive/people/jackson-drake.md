...
> **THE FUTURE in 2026 #11** ([lista](../topics/the-future-in-2026.md),
> alta 2026-07-14 s35 — *"añadamos al vanity project a la lista de
> FUTURE 2026, a todos por separado"*). Primer registro individual
> del archivo — mitad del Vanity Project junto a Blake Monroe.

## Identificación

- **Nombre de gimmick**: Jackson Drake.
- **Nombre real**: [verif].
- **Equipo/facción**: Vanity Project (con Blake Monroe).
...
### Sesión 2026-07-14 s35 — Alta a THE FUTURE + segundo WE

**Cita verbatim**:

> *"los americanos vs vanity project se merece las 3 clases, están
> muy buenos estos prospectos, de verdad es una generación muy
> poderosa esta nueva camada de NXT, añadamos al vanity project a
> la lista de FUTURE 2026, a todos por separado [...] Jackson
> Drake y el Vanity Project tienen un segmentaso, buenas promos,
> buena presencia, este se merece el enterteinment class, son
> prospectos muy top tier"*
>
> — El Vehemiurgo, 2026-07-14 s35 (verbatim)

**Lectura sintética**: entra directo a THE FUTURE con triple clase
...
> clases [...] Jackson sabe como hacer esto una pelea, no solo
> sigue el guion, se encarga de armar una pelea de verdad"*
>
...
- [`./blake-monroe.md`](./blake-monroe.md) — compañera de equipo.
- [`../topics/the-future-in-2026.md`](../topics/the-future-in-2026.md) — #11.
